...
var SocksAddressType =  ((SocksAddressType2) => {
...
class SocksConnection {
  ...
  async _authenticate() {
    ...
    this._writeBytes(Buffer.from([version, 255 ]));
    return false;
  }
  async _parseRequest() {
    const version = await this._readByte();
