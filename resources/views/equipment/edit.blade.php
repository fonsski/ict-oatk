...
<div class="max-w-7xl mx-auto px-6 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            <h1 class="text-2xl font-bold text-slate-900 mb-6">Редактировать оборудование</h1>
            ...
            <form action="{{ route('equipment.update', $equipment) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="accounting_number" id="accounting_number"
                           ...
                           value="{{ old('accounting_number', $equipment->accounting_number) }}" 
                           minlength="3" 
                           maxlength="20"
                           data-char-counter
                           data-max-length="20"
                ...
                @include('equipment.partials.operating-system-field', [
                    ...
                    'selected' => old('operating_system_id', $equipment->operating_system_id),
                ])
                ...
                <div class="mb-4">
                    ...
                    @error('initial_room_id')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-sm text-slate-500 mt-1">Указывает кабинет, в котором оборудование находилось изначально</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="service_comment" id="service_comment" rows="3"
                              ...
                              minlength="5" maxlength="500">{{ old('service_comment', $equipment->service_comment) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="known_issues" id="known_issues" rows="3"
                              ...
                              minlength="5" maxlength="500">{{ old('known_issues', $equipment->known_issues) }}</textarea>
                    @error('known_issues')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
