            ...
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                <div class="flex-1 max-w-full">
                    ...
                    <div class="flex flex-wrap gap-4 mb-4">
                        ...
                        // Используем глобальную функцию format_ticket_category
                        @endphp
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="prose max-w-none ticket-description whitespace-pre-wrap break-words max-h-96 overflow-y-auto">
                        {{ $ticket->description }}
                    </div>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div class="flex-1">
                                <div class="bg-blue-50 rounded-lg p-3">
                                    ...
                                    <div class="mt-1 text-sm text-gray-700 ticket-comment-content whitespace-pre-wrap break-words max-h-32 overflow-y-auto">
                                        {{ $comment->content }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-2 text-sm text-gray-700 ticket-comment-content whitespace-pre-wrap break-words max-h-32 overflow-y-auto">
                                    {{ $comment->content }}
                                </div>
                            </div>
                        </div>
                    ...
                    <dl class="space-y-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 flex items-center">
                                ...
                                <span class="text-sm text-gray-900 font-medium">{{ $ticket->assignedTo->name }}</span>
                                @else
                    ...
                    <form action="{{ route('tickets.assign', $ticket) }}" method="POST" id="assignForm">
                        ...
                        <div>
                            ...
                            <select id="assigned_to_id" name="assigned_to_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                ...
                                <option value="{{ $user->id }}" @if($ticket->assigned_to_id == $user->id) selected @endif>{{ $user->name }}</option>
                                @endforeach
                                @endif
                            </select>
                        </div>
