...
@section('title', 'Внутренняя ошибка сервера - Ошибка 500')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-8 mb-8">
        <div class="text-center mb-8">
            <div class="relative mx-auto mb-6">
                ...
                <div class="absolute top-0 right-0 -mt-2 -mr-2 bg-orange-600 text-white rounded-full w-12 h-12 flex items-center justify-center text-xl font-bold">
                    500
                </div>
            </div>
            <h1 class="text-3xl font-bold text-slate-900 mb-2">Внутренняя ошибка сервера</h1>
            <p class="text-slate-600 text-lg max-w-2xl mx-auto">Произошла неожиданная ошибка при обработке вашего запроса. Наши технические специалисты уже оповещены и работают над решением проблемы.</p>
        </div>

        <div class="bg-orange-50 border-l-4 border-orange-400 p-4 mb-6 mx-auto max-w-2xl">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-orange-700">
                        Пожалуйста, попробуйте обновить страницу через несколько минут. Если проблема сохраняется, свяжитесь с технической поддержкой.
                    </p>
                </div>
            </div>
        </div>
