...
@section('title', 'Редактировать кабинет - ICT Help')
...
<div class="max-w-4xl mx-auto px-6 py-8">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-slate-900 mb-2">Редактировать кабинет</h1>
            <p class="text-slate-600">Изменить информацию о кабинете {{ $room->number }}</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-slate-200">
        <form action="{{ route('room.update', $room) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description"
                              ...
                              placeholder="Дополнительная информация о кабинете">{{ old('description', $room->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="notes"
                              ...
                              placeholder="Дополнительные заметки">{{ old('notes', $room->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
