...
@section('title', 'Создать категорию - База знаний - ICT Help')
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-4">Создать категорию</h1>
                <p class="text-gray-600">
                    Добавьте новую категорию для организации статей базы знаний
                </p>
            </div>

            <form action="{{ route('knowledge.categories.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium text-white"
                         id="category-preview" style="background-color: #6B7280">
