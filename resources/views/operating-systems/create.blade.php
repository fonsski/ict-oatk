...
@section('title', 'Добавить операционную систему - ICT Help')

@section('content')
<div class="max-w-7xl mx-auto px-6 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            <h1 class="text-2xl font-bold text-slate-900 mb-6">Добавить операционную систему</h1>
            ...
            <form action="{{ route('operating-systems.store') }}" method="POST">
                @csrf
                @include('operating-systems._form')
