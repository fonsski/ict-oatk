...
@section('title', 'Создание пользователя - ICT Help')
        ...
        <div class="card p-8">
            <form method="POST" action="{{ route('user.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Нужен для восстановления пароля по коду из письма. Без него сотрудник восстановит доступ только через администратора.</p>
                    @error('email')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
