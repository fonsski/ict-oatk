...
Это руководство поможет вам настроить отправку электронной почты через SMTP Gmail в системе ICT Help.
...
4. Если включена двухфакторная аутентификация, создайте пароль приложения:
   ...
   - Выберите "Другое (указать название)" и введите "ICT Help System"
