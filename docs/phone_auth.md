...
В системе ICT Help реализована авторизация и регистрация через номер телефона без отправки SMS-кодов. Этот метод был выбран для упрощения процесса регистрации и авторизации пользователей.
