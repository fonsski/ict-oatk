# Управление очередями в системе ICT Help

В этом документе описаны принципы работы с очередями для отправки электронной почты и других асинхронных задач в системе ICT Help.
...
В системе ICT Help очереди настроены на использование базы данных для хранения заданий:
