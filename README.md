<p align="center"><img src="public/images/logo-full.png" width="400" alt="ICT Help Logo"></p>

# Система управления ИТ-инфраструктурой (ICT Help)
...
Система ICT Help — программное обеспечение с открытым исходным кодом, лицензированное под [MIT license](https://opensource.org/licenses/MIT).
